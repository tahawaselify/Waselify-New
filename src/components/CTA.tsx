    ...
    <section className="py-12 sm:py-16 md:py-20 bg-white relative" id="get-access" ref={ctaRef}>
      ...
      <div className="section-container relative z-10 opacity-0 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto glass-card p-6 sm:p-8 md:p-10 lg:p-14 text-center overflow-hidden relative">
          {/* Decorative circles */}
          <div className="absolute top-0 right-0 w-32 sm:w-40 h-32 sm:h-40 bg-waselify-100/30 rounded-full translate-x-1/2 -translate-y-1/2 blur-2xl"></div>
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6">
            Ready to Save 20+ Hours <br className="hidden sm:inline" />
            <span className="text-waselify-500">Per Week?</span>
          </h2>
          
          <p className="text-base sm:text-lg text-gray-600 mb-6 sm:mb-8 max-w-2xl mx-auto">
            Join businesses that have automated their operations with Waselify. Get your free consultation and start saving time in the next 2-3 weeks.
          </p>
