      ...
      <section className="w-full h-screen py-10 md:py-16 sticky top-0 overflow-hidden bg-white" id="why-humanoid">
        <div className="container px-6 lg:px-8 mx-auto h-full flex flex-col">
          <div className="mb-2 md:mb-3">
            <div className="flex items-center gap-4 mb-2 md:mb-2 pt-8 sm:pt-6 md:pt-4">
              <div className="pulse-chip opacity-0 animate-fade-in" style={{
                ...
                <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-waselify-500 text-white mr-2">02</span>
                <span>{t('humanoid.chip')}</span>
              </div>
            </div>
          ...
          <div ref={cardsContainerRef} className="relative flex-1 perspective-1000">
            ...
            >
              <div
                className="absolute inset-0 z-0 bg-gradient-to-br from-cyan-500 via-blue-600 to-indigo-700 animate-gradient-shift"
              ></div>
              
              <div className="absolute top-4 left-4 z-20">
                <div className="inline-flex items-center justify-center px-4 py-2 rounded-full bg-white/20 backdrop-blur-sm text-white">
                  <span className="text-sm font-medium">{t('humanoid.problem.title')}</span>
                </div>
              </div>
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center justify-center">
                <div className="max-w-lg text-center">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    {t('humanoid.problem.description')}
                  </h3>
                </div>
              </div>
            </div>
            ...
            >
              <div
                className="absolute inset-0 z-0 bg-gradient-to-br from-sky-400 via-cyan-500 to-blue-600 animate-gradient-shift-reverse"
              ></div>
              
              <div className="absolute top-4 left-4 z-20">
                <div className="inline-flex items-center justify-center px-4 py-2 rounded-full bg-white/20 backdrop-blur-sm text-white">
                  <span className="text-sm font-medium">{t('humanoid.solution.title')}</span>
                </div>
              </div>
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center justify-center">
                <div className="max-w-lg text-center">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    {t('humanoid.solution.description')}
                  </h3>
                </div>
              </div>
            </div>
            ...
            >
              <div
                className="absolute inset-0 z-0 bg-gradient-to-br from-indigo-500 via-purple-600 to-cyan-500 animate-gradient-shift"
              ></div>
              
              <div className="absolute top-4 left-4 z-20">
                <div className="inline-flex items-center justify-center px-4 py-2 rounded-full bg-white/20 backdrop-blur-sm text-white">
                  <span className="text-sm font-medium">{t('humanoid.outcome.title')}</span>
                </div>
              </div>
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center justify-center">
                <div className="max-w-lg text-center">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    {t('humanoid.outcome.description')}
                  </h3>
                </div>
              </div>
            </div>
