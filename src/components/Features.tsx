  ...
  return (
    <div 
      ...
      className={cn(
        ...
        "lg:hover:bg-gradient-to-br lg:hover:from-white lg:hover:to-waselify-50",
        "transition-all duration-300",
        "min-h-[200px] sm:min-h-[220px]"
      )}
      style={{ animationDelay: `${0.1 * index}s` }}
    >
              <div className="rounded-full bg-waselify-50 w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center text-waselify-500 mb-4 sm:mb-5">
        {icon}
      </div>
          ...
          if (part.startsWith('Result:')) {
            return (
              <p key={index} className="mt-3">
                <span className="font-semibold">{part.split(':')[0]}:</span>
                {part.split(':')[1]}
              </p>
            );
          }
      ...
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          <FeatureCard
            ...
            title={t('features.workflow1.title')}
            description={t('features.workflow1.description')}
            index={0}
          />
          <FeatureCard
            ...
            title={t('features.workflow2.title')}
            description={t('features.workflow2.description')}
            index={1}
          />
          <FeatureCard
            ...
            title={t('features.workflow3.title')}
            description={t('features.workflow3.description')}
            index={2}
          />
          <FeatureCard
            ...
            title={t('features.workflow4.title')}
            description={t('features.workflow4.description')}
            index={3}
          />
          <FeatureCard
            ...
            title={t('features.workflow5.title')}
            description={t('features.workflow5.description')}
            index={4}
          />
          <FeatureCard
            ...
            title={t('features.workflow6.title')}
            description={t('features.workflow6.description')}
            index={5}
          />
        </div>
      </div>
