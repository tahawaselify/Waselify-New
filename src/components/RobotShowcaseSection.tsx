        ...
        <div className="flex flex-col items-center opacity-0 translate-y-10 transition-all duration-1000">
          <div className="mb-12 text-center">
            <div className="pulse-chip mb-4">
                              <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-waselify-500 text-white mr-2">03</span>
          ...
          <div className="relative w-full max-w-4xl overflow-hidden rounded-3xl shadow-2xl">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-8">
              <div className="flex items-center justify-between">
                ...
                <button className="px-6 py-3 bg-waselify-500 hover:bg-waselify-600 text-white font-medium rounded-full transition-colors duration-300">
                  Learn More
                </button>
              </div>
            </div>
